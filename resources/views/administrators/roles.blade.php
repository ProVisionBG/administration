        ...
        <div class="box-body">
            <div class="panel-body">
                <table id="datatable" class="table table-bordered table-hover table-striped">
                    ...
                    <tr>
                        <th>№</th>
                        <th class="select-filter">{{trans('administration::administrators.group_key')}}</th>
                        <th class="select-filter">{{trans('administration::administrators.group_name')}}</th>
                        <th>{{trans('administration::index.actions')}}</th>
                    </tr>
                    </thead>
                    <tbody>
                    </tbody>
...
<script>
    $(function () {
        var oTable = $('#datatable').DataTable({
            ...
            "ordering": true,
            "ajax": {
                url: '{{route('provision.administration.administrators-roles.index')}}',
                data: function (d) {
